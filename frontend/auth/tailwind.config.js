  ...
  theme: {
    extend: {
      colors: {
        ...
        green: {
          // Темные оттенки (для текста и акцентов)
          1000: "#2d3d24",
          900: "#639149",
          800: "#5a8542",
          700: "#6b9652",

          // Основные цвета (для кнопок и акцентов)
          600: "#7da662",
          500: "#83af6a",
          400: "#8aab55",

          // Светлые оттенки (для фонов и ховеров)
          300: "#a8c795",
          200: "#c5dbb6",
          100: "#e0edd8",
          50: "#f0f0e4",
    ...
    plugin(function ({ addBase, theme, addUtilities }) {
      addBase({
        ":root": {
          ...
          "--button-primary-enabled": theme("colors.green.800"),
