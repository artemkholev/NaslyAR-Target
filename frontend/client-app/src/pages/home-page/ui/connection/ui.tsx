...
export const Connection = () => {
  return (
    <article id='connection' className='page__box'>
      <h1 className='typography__title--large text-center'>Связаться с нами очень просто!</h1>
      <div className='w-full flex bg-[#232424] rounded-[30px] p-14 gap-20 max-lg:flex-col'>
        ...
        <div className='h-full flex flex-col gap-5'>
          ...
          <input className='h-[60px] rounded-[30px] p-6' placeholder='Номер телефона' type='text' />
