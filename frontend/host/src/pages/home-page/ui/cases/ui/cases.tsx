...
export const Cases = () => {
  ...
  const casesButtonsContent = casesArray.map((caseButton: Case) => (
    <button
      ...
      className={`text-nowrap bg-gradient-bg bg-[length:300%_300%] animate-bg-gradient h-[55px] p-4 rounded-full text-white shadow-lg hover:shadow-[#787FF6]/50 focus:border-none focus:shadow-none ${
        caseButton.isActive ? "bg-gradient-to-r from-[#1CA7EC] via-[#1D6AC1] to-[#1E2F97]" : ""
      }`}>
