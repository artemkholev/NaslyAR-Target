...
import { ImageRender } from "@/shared/ui/image-render";
...
export const MainInfo: React.FC = () => {
  ...
  return (
    <article
      id='main-info'
      className='h-[400px] max-2xl:h-[500px] max-md:h-[600px] max-sm:h-[700px] flex relative overflow-hidden justify-center bg-red-700'>
      <div className='flex justify-between gap-80 max-2xl:gap-64 items-start max-md:gap-8 max-md:flex-col'>
        <div className='flex flex-col gap-10 max-md:gap-5 py-5'>
          <h1 className='typography__title--max'>{t("home_page.main_info.title")}</h1>
