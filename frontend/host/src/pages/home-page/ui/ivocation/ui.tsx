...
export const Ivocation = () => {
  ...
  return (
    <section
      id='ivocation'
      className='page__box flex justify-center items-center py-20 bg-[--component-bg] rounded-[40px]'>
      <div className='w-full max-w-6xl px-6 md:px-12 grid md:grid-cols-2 gap-10 items-center'>
        {/* Текстовая часть */}
        <div className='space-y-6'>
          <h2 className='typography__title font-semibold leading-snug'>
          ...
          <p className='typography__text'>{t("home_page.ivocation.discount_for_buyer")}</p>
        </div>
        ...
        <div className='relative bg-white p-8 rounded-3xl shadow-regular space-y-6'>
          ...
          <span className='absolute top-[-10px] right-[-10px] text-sm bg-green-400 text-white px-3 py-1 rounded-full shadow-md rotate-6'>
